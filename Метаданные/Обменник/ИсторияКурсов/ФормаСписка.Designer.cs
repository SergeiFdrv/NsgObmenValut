...

{
    ...
    public partial class ИсторияКурсовФормаСписка:NsgSoft.Forms.NsgMultipleObjectBaseForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Валюты = new ОбменникВалют.Метаданные.Обменник.Валюты.ColumnDescriptor();
            this.ДатаВремя = new NsgSoft.Forms.NsgColumnDescriptor.DateTime();
            this.Значение = new NsgSoft.Forms.NsgColumnDescriptor.Decimal();
            this.Родитель = new ОбменникВалют.Метаданные.Обменник.ИсторияКурсов.ColumnDescriptor();
            ...
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.Валюты);
            this.nsgVisualMultipleObject.Columns.Collection.Add(this.ДатаВремя);
            ...
            this.nsgVisualMultipleObject.FullName = "Обменник.ИсторияКурсов";
            // 
            // Идентификатор
            // 
            ...
            // Валюты
            // 
            this.Валюты.AutoGenerated = true;
            this.Валюты.Caption = "Валюты";
            this.Валюты.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectBaseForm);
            this.Валюты.Name = "Валюты";
            this.Валюты.NSGType = typeof(ОбменникВалют.Метаданные.Обменник.Валюты);
            this.Валюты.PropertyType = typeof(ОбменникВалют.Метаданные.Обменник.Валюты);
            this.Валюты.SearchCondition.OwnerComponent = this.Валюты;
            this.Валюты.SearchCondition.Parameters = new NsgSoft.DataObjects.NsgCompareParam[0];
            // 
            // ДатаВремя
            // 
            this.ДатаВремя.AutoGenerated = true;
            this.ДатаВремя.Caption = "ДатаВремя";
            this.ДатаВремя.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectBaseForm);
            ...
            this.Значение.Creator = typeof(NsgSoft.Forms.NsgMultipleObjectBaseForm);
            ...
            this.Родитель.NSGType = typeof(ОбменникВалют.Метаданные.Обменник.ИсторияКурсов);
            this.Родитель.PropertyType = typeof(ОбменникВалют.Метаданные.Обменник.ИсторияКурсов);
        ...
        "Visible"};
            ...
            nsgIGridColumn5.Name = "ДатаВремя";
        ...
        private Валюты.ColumnDescriptor Валюты;
        private NsgColumnDescriptor.DateTime ДатаВремя;
        private NsgColumnDescriptor.Decimal Значение;
        protected ИсторияКурсов.ColumnDescriptor Родитель;
