...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataAssemblyObject", Guid = "f8821df7-2795-4197-bd69-283d3748efa5")]
    public partial class DataAssemblyObject : NsgSoft.DataObjects.NsgDataAssemblyObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("f8821df7-2795-4197-bd69-283d3748efa5"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("8d8805d0-1b85-4bb8-9c0a-1258b1128959");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("6ebd337b-19dc-4f0d-afc1-3e5c36902e66");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("94168af8-eb77-4097-b60f-daf0c80eaf0b");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("3b00bdd1-700a-4ca3-ac01-0c2d4b7baed3");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("d800abdc-d328-4b80-8d87-69f6cd70999d");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("cced861a-42cf-461c-b88c-c72e1edfd3fd");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("db955e5b-712c-479d-970d-e81ef2cbdcc5");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("eb4a85ac-0d56-43c1-b8a8-afb71d9b69ad");
	...
	_AsmName.GroupName = "";
	_AsmName.Guid = NsgService.StringToGuid("4fe239ef-976a-43af-97d1-da008886911d");
	...
	_AsmVersion.Guid = NsgService.StringToGuid("ba8c27fa-984b-401b-92fc-c349516bc2f3");
	...
	_AsmHash.GroupName = "";
	_AsmHash.Guid = NsgService.StringToGuid("7735945e-f71f-4492-9b99-b7c70a11f020");
	...
	_AsmData.GroupName = "";
	_AsmData.Guid = NsgService.StringToGuid("3179c23b-98e8-4844-9185-0afd739e0054");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("afe4adfd-bdbe-4928-a62d-4d7e83bbcb9f");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("f8821df7-2795-4197-bd69-283d3748efa5");
	DefaultSortingName = "";
