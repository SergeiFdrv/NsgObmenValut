...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "c7ad3018-6b38-4bb7-8ddd-acdba8f362e1")]
    public partial class БазыДанныхДляОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("c7ad3018-6b38-4bb7-8ddd-acdba8f362e1"));
            if (obj == null)
