...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataCharacteristics", Guid = "eb13bb93-839c-42dd-be49-dd28ea6942ae")]
    public partial class ПечатныеФормы : NsgSoft.DataObjects.NsgDataCharacteristics
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("eb13bb93-839c-42dd-be49-dd28ea6942ae"));
            if (obj == null)
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("2913ade9-f85e-47b4-8a88-b556da46b88f");
	...
	КонецПериода.Guid = NsgService.StringToGuid("46d21aa2-4150-469e-b07d-a04fabf789db");
	...
	Идентификатор.Guid = NsgService.StringToGuid("b8ca598b-602a-490f-acee-327c021202e5");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("785fca4d-ccf4-430c-be03-eeffae708343");
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("a9d91b37-d17d-4586-8b93-3f15f366dba6");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("826dcf83-9ec9-48c9-bf23-c9bcf52d4a38");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("53880aac-5c66-42e1-8d19-cd74a094a060");
	...
	Обработка.GroupName = "";
	Обработка.Guid = NsgService.StringToGuid("8e13fba9-21a7-4e82-a849-5840f66d1d02");
	...
	Наименование.Guid = NsgService.StringToGuid("680eb9ef-6cb3-4130-b8b6-5488e9b07c9b");
	...
	ПечатнаяФорма.Guid = NsgService.StringToGuid("268831bd-049e-43c7-b684-e1c935c5fa28");
	...
	Условие.GroupName = "";
	Условие.Guid = NsgService.StringToGuid("987abefc-6851-4ed2-8bbb-abda1c3bfc1e");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("3a1bb88f-13d0-4027-a066-cb2b5041d2b2");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("d11f9044-a3d3-418f-aa77-319edc456259");
	...
	Name = "ПечатныеФормы";
	Visible = true;
	Guid = NsgService.StringToGuid("eb13bb93-839c-42dd-be49-dd28ea6942ae");
	DefaultSortingName = "";
