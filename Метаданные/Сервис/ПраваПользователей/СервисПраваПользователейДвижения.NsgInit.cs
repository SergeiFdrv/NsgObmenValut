...
namespace ОбменникВалют.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "89744974-6dcc-46f1-8ea2-d5570d4236f4")]
	...
	Идентификатор.Guid = NsgService.StringToGuid("93a8a176-fff1-45d8-93a4-f35badd10402");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8b4b21a7-2fce-452a-b749-89dcc18d4a47");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("8a2c376c-bf88-468c-a076-ffab59d03705");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("89744974-6dcc-46f1-8ea2-d5570d4236f4");
	DefaultSortingName = "";
