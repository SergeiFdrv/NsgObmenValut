...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "dec29eb0-f40d-4529-9c2e-7e46f14dd6ae")]
    public partial class НеактуальностьИтоговРегистров : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("dec29eb0-f40d-4529-9c2e-7e46f14dd6ae"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("4185ea0a-14d8-4861-a7a0-d4b48bd469cb");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("df7851f9-788a-4d5c-ba15-327ca6824fed");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("70a347f6-c98c-4d11-ace4-84f191a73169");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("8dbac0df-03bd-4262-b1eb-a2a33f910e21");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("557668fb-45ee-4c46-829f-969c3f03e731");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("435c222f-dde9-4120-b13a-96857b3de081");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("96a28043-4e5a-467e-885e-ab60a1879cd7");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("9bfe4f9f-8c84-4294-be5f-f030d64dfe07");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("94dd0d3e-25a0-43c0-a297-5e5229cf42fa");
	...
	ИдентификаторОбъекта.Guid = NsgService.StringToGuid("c40151e1-4e73-4aaf-ba3f-0c3251f6495e");
	...
	ВладелецДвижения.Guid = NsgService.StringToGuid("2b7a5d1d-80b9-4337-9f3c-c1d1cb592536");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("a428ff96-73de-4944-8a20-83f030070f0a");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("ab429440-c74d-4c6c-963f-aa7775c9a702");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("dec29eb0-f40d-4529-9c2e-7e46f14dd6ae");
	DefaultSortingName = "";
