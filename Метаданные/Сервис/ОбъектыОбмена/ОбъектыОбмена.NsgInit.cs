...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "fa683ca1-fe28-4689-b438-6d7c8a566d1e")]
    public partial class ОбъектыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("fa683ca1-fe28-4689-b438-6d7c8a566d1e"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("ff4b2801-7e79-4a8f-a137-a3038cf8afa1");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("e5fc029a-9102-429b-869b-e11932becd2b");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("49258f89-c762-4772-beb3-0e214ba0c2b2");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("89c4484b-85a9-43f2-ae7a-733e9dcc91b8");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("7acbf69d-d118-4c60-812c-0546860d4b74");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("0ad39f71-8179-446d-ae30-58e8ff958778");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("cb45f405-8cf1-4c6f-9795-8d77b6ab8034");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("721b32f0-0823-4741-a586-5e2fa186c908");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("ffab9e8f-4dc7-45b2-9844-526ecea08c01");
	...
	ОбъектОбмена.Guid = NsgService.StringToGuid("779a1d36-d203-4027-a0a1-451464384908");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("7f637ef6-a733-4cfb-a5da-de5585c59126");
	...
	НомерОбмена.Guid = NsgService.StringToGuid("f2e077e3-23e9-417a-a797-562ced1a4917");
	...
	Name = "ОбъектыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("fa683ca1-fe28-4689-b438-6d7c8a566d1e");
	DefaultSortingName = "";
