...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "41bfc977-8a59-4937-9317-d768f07bccbc")]
    public partial class ЭлементМенюПользователя : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("41bfc977-8a59-4937-9317-d768f07bccbc"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("640c39ab-1bbb-4a32-9141-2ef12e554dde");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("6c99417e-0203-4502-bfe3-ff4ec1b6e4b4");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("19e54568-46be-469e-98fb-61e0052c02e3");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("45ad7361-55db-4a44-95be-1c96e99195c7");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("1c69b656-e60e-4546-8f52-94ee6a09e018");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("37cfb652-65d7-45b4-9c84-f7ec04dec375");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("8b6a028f-2028-448e-83af-e74a29a83a57");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("b0732602-d983-49ce-a35b-0c00949dc349");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("f5c1956a-fae2-4918-ade3-d8010a539674");
	...
	Наименование.Guid = NsgService.StringToGuid("81875f49-b8f4-499c-acc7-3ab9f234d95c");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("29959e77-f7be-4289-9ae2-df5eef849cd0");
	...
	Картинка.GroupName = "";
	Картинка.Guid = NsgService.StringToGuid("1e056336-2941-4dc8-b229-9ee8c9165b45");
	...
	БольшаяИконка.Guid = NsgService.StringToGuid("2ae3fe64-40c5-4078-aa5b-e5f4b72c101b");
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("e4e61dd1-c8d9-4c05-925c-24cfa41aaffb");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("41bfc977-8a59-4937-9317-d768f07bccbc");
	DefaultSortingName = "";
