...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "92821939-e83b-4dc3-8397-a1c9d56551d9")]
    public partial class ОбменДанными : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("92821939-e83b-4dc3-8397-a1c9d56551d9"));
            if (obj == null)
