...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "98a908c1-410c-4098-9995-5efc358b26a2")]
    public partial class СервисноеОбслуживание : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("98a908c1-410c-4098-9995-5efc358b26a2"));
            if (obj == null)
