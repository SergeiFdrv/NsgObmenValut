...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "52e3879b-f8bf-45db-a379-881a30f28716")]
    public partial class ТипыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("52e3879b-f8bf-45db-a379-881a30f28716"));
            if (obj == null)
                obj = new ТипыОбмена();
	...
	Идентификатор.Guid = NsgService.StringToGuid("71f0ed6d-658a-4872-8df9-8b18ebbd0819");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("f99bba25-2b5f-4750-866d-372ff6b8fae9");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("e0512052-3b5f-4503-b0df-4d3267f316ff");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("0c5ed585-b5c4-4a95-b2ef-a398cc1afc1f");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("ec24249b-1329-47c5-a23f-d6a7e210305c");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("1d6d8053-5e5c-4fdd-b8ac-65c877700b32");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("6337360a-b20f-4d40-831f-4298dd231986");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("020f7e46-1e6b-4365-8479-15dda80afaad");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("5a0e1756-b4e0-4156-9428-8cf8eaa9b138");
	...
	Наименование.Guid = NsgService.StringToGuid("2d054ecf-3100-4488-81e1-582329173505");
	...
	Файл.Guid = NsgService.StringToGuid("42ac12e1-4ac6-477c-9b07-fbf07af18670");
	...
	Email.Guid = NsgService.StringToGuid("194832e9-d2b3-4457-a304-a1f1da474e2d");
	...
	SQL.Guid = NsgService.StringToGuid("52d32de9-5a45-49ed-8b1d-585633f1300a");
	...
	Name = "ТипыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("52e3879b-f8bf-45db-a379-881a30f28716");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        public static ТипыОбмена Файл
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("52e3879b-f8bf-45db-a379-881a30f28716"), NsgService.StringToGuid("42ac12e1-4ac6-477c-9b07-fbf07af18670"));
            }
        }
        ...
        public static ТипыОбмена Email
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("52e3879b-f8bf-45db-a379-881a30f28716"), NsgService.StringToGuid("194832e9-d2b3-4457-a304-a1f1da474e2d"));
            }
        }
        ...
        public static ТипыОбмена SQL
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("52e3879b-f8bf-45db-a379-881a30f28716"), NsgService.StringToGuid("52d32de9-5a45-49ed-8b1d-585633f1300a"));
            }
        }
