...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "1d4fa0fd-6a96-43e8-80a5-63a888cb096a")]
    public partial class РольПользователяМеню : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("1d4fa0fd-6a96-43e8-80a5-63a888cb096a"));
            if (obj == null)
