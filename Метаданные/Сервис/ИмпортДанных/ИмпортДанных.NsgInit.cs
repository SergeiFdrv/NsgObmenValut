...
namespace ОбменникВалют.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "d533e0bf-a35d-4d3a-8e22-c163d12511f3")]
    public partial class ИмпортДанных : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d533e0bf-a35d-4d3a-8e22-c163d12511f3"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("6cabf683-ee75-4d27-99cd-754ab077bd24");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8180bd4d-5144-48d1-894a-7669d05a377b");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("7687fe28-5d5b-4b33-943a-765bf8a346bc");
	...
	Name = "ИмпортДанных";
	Visible = true;
	Guid = NsgService.StringToGuid("d533e0bf-a35d-4d3a-8e22-c163d12511f3");
	DefaultSortingName = "";
